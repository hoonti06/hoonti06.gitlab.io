...
updated   : 2021-08-27 14:58:26 +0900
jag       : 
public    : true
published : true
parent    : 
...
- Cloud provider 대부분이 container 이미지 remote 저장소 서비스를 제공하고 있다.
	- Github의 [GitHub Container Registry](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-container-registry )
		- 500MB까지 무료 ([가격 참고](https://github.com/features/packages#pricing ))
	- AWS의 [ECR(EC2 Container Registry)](https://aws.amazon.com/ko/ecr/ )
		- Public 저장소 50GB까지 무료 ([가격 참고](https://aws.amazon.com/ko/ecr/pricing/?loc=ft#AWS_Free_Tier ))
	...
	- Google의 [GCR(Google Container Registry)](https://cloud.google.com/container-registry )
		- 멀티 리전의 표준 버킷 가격은 월별 GB당 약 $0.026 ([가격 참고](https://cloud.google.com/container-registry/pricing?hl=ko ))
