...
updated   : 2021-08-30 15:55:56 +0900
jag       : 
public    : true
published : true
parent    : 
...
## 2021-08-30
- EC2에 sonatype/nexus3를 docker container로 설치해서 실행했는데, 메모리가 충분하지 않다고 에러가 발생했다. [reference](https://help.sonatype.com/repomanager3/installation/system-requirements#SystemRequirements-GeneralMemoryGuidelines )를 찾아보니 최소 8GB 이상이어야 하는 듯 하다..
