...
updated   : 2021-07-31 13:16:28 +0900
jag       : 
public    : true
published : true
parent    : 
...
- openvidu tutorial과 openvidu를 docker로 VM에 올렸는데, 세션 입장하는 과정에서 계속 실패했다
	- 알고보니 버전 문제였다
	- openvidu의 옛날 버전(2.12.0)의 reference를 보고 있었고, 해당 버전은 최신 tutorial과 호환이 안되는 듯 하다.
	- openvidu의 최신 버전(2.19.0)도 시도했는데, 2.12.0 버전에 맞는 설정을 하고 있어서 안 됐었다.
		- 설정값 이름의 차이가 있었다.
	- 최신 tutorial과 최신 openvidu 버전과 최신 버전에 맞는 설정을 하니 잘 되었다.
