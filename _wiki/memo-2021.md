...
updated   : 2021-07-21 01:21:18 +0900
jag       : 
public    : true
published : true
parent    : 
...
- git subtree
	- study-demo-code 하위 directory에 다른 git repo를 history 유지하면서 들여오고 싶어서 사용하였다.(로컬에 있는 git을 적용했는데, 당연히 url을 통한 remote repository도 가능하다)
	```sh
